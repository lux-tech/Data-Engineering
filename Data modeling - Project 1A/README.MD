...
- start_time (DATE) : Timestamp of beggining of user activity
...
- user_id (INT) NOT NULL PRIMARY KEY: ID of user
- first_name (TEXT) : Name of user
- last_name (TEXT) : Last Name of user
- gender (TEXT): Gender of user {M | F}
- level (TEXT): User level {free | paid}:CONFLICT (user_id) DO UPDATE SET level=EXCLUDED.level

**songs** - songs in music database
- song_id (TEXT) NOT NULL PRIMARY KEY: ID of Song
...
- artist_id (TEXT) NOT NULL PRIMARY KEY: ID of Artist
...
6.Run etl in console/Notebook, and verify results:
python etl.py
